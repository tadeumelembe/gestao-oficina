                        ...
                        <div class="pb-3 mb-3" style="border-bottom: #dedede solid 1px;">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="float-right pr-2 ">
                                        @if($jobCard->status != 'Fechado')
                                        @if($jobCard->status == 'Em curso')
                                        <a href="/jobs/close/{{$jobCard->id}}" status="Fechado" class="btn btn-danger mb-2 job_status"><i class="mdi mdi-stop mr-2"></i>Fechar</a>
                                        @else
                                        <a href="/jobs/start/{{$jobCard->id}}" status="Em Progresso" class="btn btn-success mb-2 job_status"><i class="mdi mdi-play mr-2"></i>Iniciar</a>
                                        @endif
                                        @endif
                            ...
                            <div class="row pt-2">
                                ...
                                <div class="col-6 col-sm-4">
                                    ...
                                    <h6>{{$jobCard->dataInicio}}</h6>
                                </div>
                                <div class="col-6 col-sm-4">
                                    <small class="text-muted">Data de Fim</small>
                                    <h6>{{$jobCard->dataFim}}</h6>
                                </div>
                        ...
                        <div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-8 col-md-4 float-right">
                                    <img class="mr-0" src="{{asset('uploads/photo_car/'.$jobCard->car->photo)}}" style="width: 100%;" alt="">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="text-center pb-3" style="border-bottom: #ededed solid 1px;">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <h6 class="mb-0"><?= number_format($jobCard->valor, 2, '.', ',') ?> MT</h6>
                                        </div>
                                        <div class="col-sm-6">
                                            <i class="ri-arrow-up-line" style="color: red;font-size:large"></i>

                                            <p class="text-muted mb-2">Despesas</p>
                                            <h6 class="mb-0"><?= number_format($despesas, 2, '.', ',') ?> MT</h6>
                                        </div>
                                    </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-4">
                                <select id="activity_id" class="form-control">
                                    <option value="Y">Selecione Actividade</option>
                                    @forelse ($jobCard->actividades as $actividade)

                                    <option value="{{$actividade->id}}">{{$actividade->nome}}</option>

                                    @empty
                                    <option value="X">Sem Actividades</option>
                                    @endforelse
                                </select>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="float-right pr-2 mb-2">
                                    <a href="javascript:void(0);" class="btn btn-success mb-2" data-toggle="modal" data-target=".document-create-modal"><i class="mdi mdi-plus mr-2"></i>Add documento</a>
                                </div>
                            </div>
                        </div>
                        <div class="text-center pb-3" style="border-bottom: #ededed solid 1px;">
                            <div class="row">
                                @include('jobs.assets.show.documents')
                            </div>
                        </div>
...
@include('jobs.assets.show.js')
@include('jobs.assets.show.createActivity')
@include('jobs.assets.show.activities.createConsumivel')
@include('jobs.assets.show.activities.createFuncionario')
@include('jobs.assets.show.activities.createImagem')
@include('jobs.assets.show.documentCreate')
